...
public class FilesRepo extends IdRepo {
    ...
    // JIRA admin user
    private String jiraAdminUser = "carlos.devoto@compuware.com";
    ...
    private String jiraAdminPassword = "June2013";
	        ...
	        while (retry > 0) {
		        try {
		        	...
		        	if (ex.getCause() instanceof SecurityException) {
		        	    adminToken = adminTokenManager.refreshToken(adminToken);
		        	    retry --;
		        	} else {
		        		throw ex;
		        	}
